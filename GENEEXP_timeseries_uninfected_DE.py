...
file_path = "working_data/preprocessed_PETRI_outputs/09Oct2024_Luz19_0-40min_18000/09Oct2024_mixed_species_gene_matrix_preprocessed.h5ad"  # "working_data/preprocessed_PETRI_outputs/13Nov2024RTmultiinfection_15000/RTmulti_mixed_species_gene_matrix_preprocessed.h5ad"
...
results_df.to_csv("union_top_DE_genes_expression_by_group.csv", index=False)

print(
    "Done! CSV file 'union_top_DE_genes_expression_by_group.csv' has been created with expression data for the union of top DE genes across groups.")
