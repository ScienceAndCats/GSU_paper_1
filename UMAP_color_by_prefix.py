...
# App layout without the infected/uninfected hue sliders.
app.layout = html.Div([
    html.Label("Set CSV file name:"),
    dcc.Input(id="file-name-input", type="text",
              value='DD2PAL_mixed_species_gene_matrix_multihitcombo.txt'),
...
# Callback to update UMAP and store processed and raw data.
@app.callback(
