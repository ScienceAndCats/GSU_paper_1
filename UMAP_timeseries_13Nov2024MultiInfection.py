...
# Updated classification function with new time groups
...
# App layout with updated group color controls and legend order for the new groups.
app.layout = html.Div([
    html.Label("Set CSV file name:"),
    dcc.Input(
        id="file-name-input",
        type="text",
        value='working_data/preprocessed_PETRI_outputs/13Nov2024RTmultiinfection_15000/RTmulti_mixed_species_gene_matrix_preprocessed.txt'
    ),
    html.Br(), html.Br(),
    ...
    html.Br(), html.Br(),
    # Updated group color controls for four groups:
    html.Label("5min Color:"),
    dcc.Input(id="color-5min", type="text", value="#00008B"),
    html.Br(),
    html.Label("10min Color:"),
    dcc.Input(id="color-10min", type="text", value="#2ca02c"),
    html.Br(),
    html.Label("15min Color:"),
    dcc.Input(id="color-15min", type="text", value="#ff7f0e"),
    html.Br(),
    html.Label("20min Color:"),
    dcc.Input(id="color-20min", type="text", value="#d62728"),
    html.Br(),
    html.Label("Legend Order (comma separated):"),
    dcc.Input(id="legend-order", type="text", value="5min,10min,15min,20min"),
    html.Br(), html.Br(),
...
@app.callback(
    ...
    State("color-5min", "value"),
    State("color-10min", "value"),
    State("color-15min", "value"),
    State("color-20min", "value"),
...
def update_umap(n_clicks, file_name, min_counts_cells, min_counts_genes,
                ...
                color_5min, color_10min, color_15min, color_20min, legend_order,
