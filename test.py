...
def update_umap_and_svm(n_clicks, file_name,
    ...
    top_indices = np.argsort(abs_values)[::-1][:100] # Returns the indices that would sort the array in ascending order, reverse it to get descending sort, then take the top 10
